...
export default function EmployeeDashboard() {
    ...
    const [activeTab, setActiveTab] = useState('attendance'); // 'attendance' | 'materials'
    ...
    return (
        <div className="max-w-5xl mx-auto space-y-8">
            ...
            <div className="flex flex-col md:flex-row justify-between items-center gap-6">
                <div>
                    ...
                    <div className="flex items-center gap-3 mt-3">
                        ...
                        {/* Tab Switcher */}
                        <div className="flex bg-slate-800/50 p-1 rounded-full border border-white/5 ml-4">
                            <button
                                onClick={() => setActiveTab('attendance')}
                                className={`px-4 py-1.5 rounded-full text-xs font-bold uppercase tracking-wider transition-all ${activeTab === 'attendance' ? 'bg-primary/20 text-primary shadow-sm' : 'text-slate-400 hover:text-white'
                                    }`}
                            >
                                Chấm Công
                            </button>
                            <button
                                ...
                                className={`px-4 py-1.5 rounded-full text-xs font-bold uppercase tracking-wider transition-all ${activeTab === 'materials' ? 'bg-emerald-500/20 text-emerald-400 shadow-sm' : 'text-slate-400 hover:text-white'
                                    }`}
                            >
                                Nguyên Liệu
                            </button>
                ...
                <div className="flex items-center gap-4">
                    <button
                        ...
                        className="glass-button w-10 h-10 p-0 flex items-center justify-center text-slate-300 hover:text-white"
                        title="🔑 Đổi Mật Khẩu"
                    >
                        <Edit2 size={18} />
                    </button>
            ...
            {/* Materials Tab */}
            {activeTab === 'materials' && (
                <MaterialsInput currentUser={currentUser} />
            )}
        </div>
    );
}
