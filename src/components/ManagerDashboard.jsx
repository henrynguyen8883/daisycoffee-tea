...
export default function ManagerDashboard() {
    ...
    const [formData, setFormData] = useState({ name: '', role: 'server', customRate: '', password: '' });
    ...
    const handleAddSubmit = (e) => {
        ...
        setIsAdding(false);
        setFormData({ name: '', role: 'server', customRate: '', password: '' });
    };
            ...
            <div className="glass-panel p-6 flex flex-col md:flex-row justify-between items-center gap-4 mb-8 relative z-10">
                ...
                <div className="flex bg-slate-800/50 p-1 rounded-xl">
                    ...
                    <button
                        ...
                        className={`px-4 py-2 rounded-lg text-sm font-medium transition-all ${activeTab === 'materials' ? 'bg-amber-500/20 text-amber-400 shadow-sm' : 'text-slate-400 hover:text-slate-200'}`}
                    >
                        Kho & Báo Cáo
                    </button>
                </div>
